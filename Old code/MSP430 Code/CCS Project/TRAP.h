...
//Frequency at which it trasmit (Needed to understand which node is sending)
//change for each node
#define TX_FREQUENCY 30
...
void sendData(int energy_level, TX_Status nodeState, int pulsesCountRX, MOD_Status nodeMode, int dataTXTime);
int selectBurstLength(int energy_level);
